...
// ✅ Add a guest and send notification
export const addGuest = async (req, res) => {
    try {
        ...
        // Fetch event details and populate the createdBy field (user's name)
        ...
        // ✅ Get the event organizer's name
...
// ✅ Get all guests for an event with monitoring details
...
// ✅ Remove a guest and notify them
export const deleteGuest = async (req, res) => {
    try {
        ...
        // ✅ Send notification to the guest about removal
        await sendNotification(
            guest.email,
...
export const confirmGuest = async (req, res) => {
    try {
        ...
        // Find and update the guest's status
